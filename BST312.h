...
Postconditions: newItem is in the proper position for a BST, if newItem is a duplicate
                the newItem always goes to the left side of the duplicate item
*****************************/
...
Function: Removes target from BST. If there are duplicate elements,
...
Function: Determines if a given Item is in tree.
          If there are duplicate elements, return true when found the first element
Preconditions: BST has been initialized.
Postconditions: none
*****************************/
...
void BST_312 <ItemType>::insertItem(TreeNode*& t, const ItemType& newItem)
{
    if(t == NULL){
        ...
        //duplicate always goes to the left side
        if((newItem < t->data) || (newItem == t->data) ){
